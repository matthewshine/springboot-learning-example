import com.kouryoushine.autoconfigdemo.HelloServiceProperties;
import com.kouryoushine.autoconfigdemo.HornetQAutoConfiguration;
import com.kouryoushine.autoconfigdemo.HornetQConfigurationCustomizer;
...
public class HornetQAutoConfigurationTest {
	...
	@Test
	public void enablepropertiesTest(){
		System.out.println(helloServiceProperties.getName());
	}
